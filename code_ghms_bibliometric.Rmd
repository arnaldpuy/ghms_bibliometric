...
```{r keywords_time, fig.height=2.5, fig.width=3.5, dependson="arrange_data"}
...
```{r merge_plots_descriptive, fig.height=4.8, fig.width=5.5, dependson=c("keywords_time", "fraction_unc", "cumulative_plot"), warning=FALSE}
...
```{r plot_permodel, dependson="tokens", fig.height=6, fig.width=5}
