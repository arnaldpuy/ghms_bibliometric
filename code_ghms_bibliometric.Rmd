...
```{r arrange_data, dependson="bibliometric"}
...
## Institutional legacy in models

```{r analyse_data, dependson="arrange_data"}
...
```{r histogram_legacy, dependson="analyse_data", fig.height=2.5, fig.width=2.5}
...
```{r plot_use, dependson="analyse_data", fig.height=7, fig.width=6.5, warning=FALSE}
...
```{r keywords_analysis, dependson="arrange_data"}
...
```{r plot_bars, warning = FALSE, fig.height=2.5, fig.width=4, dependson="bibliometric"}
...
```{r merge_plots1, dependson=c("plot_time", "plot_bars"), fig.height=3.2, fig.width=6, warning=FALSE}
